...
export default function DarkModeToggle() {
  ...
  return (
    ...
    >
      {darkMode ?
       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#F3F3F3" className="md:w-6 w-6 transition-all duration-500 ease-in-out">
       ...
       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"  className="md:w-6 w-6 transition-all duration-500 ease-in-out">
