...
export function CategoryForm({ close }: any) {
  ...
  return (
    <div className="flex items-center justify-center fixed bg-[#0000006b] min-w-full min-h-full z-60 top-0 left-0">
      <div className="inter absolute w-[60vh] h-fit bg-background dark:bg-dark-background dark:ring-2 dark:ring-gray-800 shadow-md rounded-2xl z-80 p-3 overflow-y-auto"
        ...
        <form className="flex flex-col p-2 gap-y-4" onSubmit={(e) => {e.preventDefault();createCategory(category);close()}}>
            <p className="flex justify-center items-center text-2xl font-bold"><MoneyBagIcon className="w-8 mx-2"/>Añadir Categoria</p>
            ...
            <input value="Crear" type="submit" className="bg-primary py-2 px-6 rounded-full shadow-md text-white cursor-pointer hover:scale-104 transition-all duration-200 ease-in-out"/>
