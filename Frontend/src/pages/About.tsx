  ...
  <>
    ...
    <div className="min-h-screen bg-white dark:bg-dark-background pt-20">
      ...
      <div className="bg-gradient-to-b from-[#5B3FD8] via-[#5545C8] to-[#7B5FE8] dark:from-[#3023AE] dark:to-[#5B47D8] py-12 md:py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <NavLink to="/dashboard">
                <button className=" inter relative w-42 h-10 bg-primary text-white rounded-full overflow-hidden group cursor-pointer shadow-md">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-8 md:py-16">
        ...
        <div className="bg-gray-50 dark:bg-dark-card rounded-2xl md:rounded-3xl shadow-sm p-5 md:p-10 mb-8 md:mb-16">
          <div className="grid lg:grid-cols-[1.2fr,1fr] gap-6 md:gap-10">
            {/* Left Side - Control */}
            <div>
              <h3 className="mont_semibold text-xl md:text-2xl text-black dark:text-white mb-3 md:mb-4">
                {t('control_title')}
              </h3>
              <p className="inter text-gray-600 dark:text-gray-300 mb-4 md:mb-6 text-xs md:text-sm leading-relaxed">
