  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center mx-5">
        ...
        {/*--- CARD 1 --- */}
        <div className="grid grid-cols-3 max-w-[1280px] min-h-[500px] bg-white dark:bg-[#0F1732] w-full sm:h-[500px] h-fit rounded-3xl shadow-md ring-2 ring-gray-200 dark:ring-[#050b1f] p-10">
      ...
      {/* --- CONTAINER 5 --- */}
      <div className="pt-40"></div>
      <div className="flex flex-col justify-center items-center text-black dark:text-[#D8E0F9] mx-4 pb-24">
