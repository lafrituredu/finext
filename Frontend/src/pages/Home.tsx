...
function Home() {
  ...
  return (
    <>
      ...
      {/* --- COINTAINER 2 --- */}
      <div className="pt-40"></div>
      <div className="bg-gray-300 dark:bg-gray-800 w-full h-30"></div>
      {/* --- COINTAINER 3 --- */}
      <div className="pt-40"></div>
      <div className="flex flex-col justify-center items-center mx-5 xl:mx-[320px]">
        <div>
        ...
        <div className="grid grid-cols-3 bg-white dark:bg-[#0F1732] w-full h-[500px] rounded-3xl shadow-md ring-2 ring-gray-200 dark:ring-[#050b1f] p-10">
          <div className= "sm:col-span-2 col-span-3">
            <div className="flex flex-col">
              <div className="flex sm:flex-row flex-col items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#84A2EB" className="w-24 h-24 mx-5 my-5 sm:my-0"><path d="M200-80v-760h640l-80 200 80 200H280v360h-80Zm80-440h442l-48-120 48-120H280v240Zm0 0v-240 240Z"/></svg>
                <p className="mont_semibold sm:text-4xl text-xl">{t('intelligent_expense')}</p>
              </div>
              <p className="inter pt-10 text-lg">{t('intelligent_expense_text')}.</p>
            </div>
          </div>
          <div className="sm:flex hidden sm:col-span-1 justify-center items-center italic">Img here</div>
        </div>
      ...
      {/* --- COINTAINER 4 --- */}
      <div className="pt-40"></div>
      <div className="flex mx-[320px]">
        <div className="w-full h-180 bg-linear-to-br from-[#70A1FF] to-[#1E4CA3] rounded-4xl"></div>
      </div>
      {/* --- CONTAINER 5 --- */}
      <div className="pt-40"></div>
      <div className="flex flex-col justify-center items-center text-black dark:text-[#D8E0F9]">
        <div className="flex flex-col justify-center items-center pt-12">
          ...
          <p className="montserrat text-4xl">Managing money is messy</p>
          <p className="max-w-140 text-center">When your finances are spread across different tools and accounts, it becomes difficult to understand your real situation. Expenses, taxes, and goals quickly turn into confusion.</p>
        </div>
        <div className="flex flex-col justify-center items-center pt-12">
          ...
          <p className="montserrat text-4xl">Why we built this app?</p>
          <p className="max-w-140 text-center">We created this platform to simplify financial management and give people a clear understanding of their money, without complexity or confusion.</p>
        </div>
        <div className="flex flex-col justify-center items-center pt-12">
          <img src="/icons/finext.svg" alt="" className="w-24 h-24"/>
          <p className="montserrat text-4xl">Ready to try FiNext?</p>
          <p className="max-w-140 text-center">Join now and experience a smarter way to manage your money.</p>
        </div>
        <div className="pt-12">
          <button className="bg-[#84A2EB] py-3 px-12 rounded-full text-shadow-white text-white shadow-md cursor-pointer">{t('start_now')}</button>
        </div>
